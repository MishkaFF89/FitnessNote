...
class CompareAdapter(): ListAdapter<ExerciseItem, CompareAdapter.ItemHolder>(ItemComporator()) {


    class ItemHolder(item: View) : RecyclerView.ViewHolder(item) {
        private val binding = ExerciseItemBinding.bind(item)

        fun setData(exerciseItem: ExerciseItem) = with(binding) {
            tvNameExercise.text = exerciseItem.name
            curentTime.text = exerciseItem.time
            imEditExercise.visibility = View.GONE
            imDeleteExercise.visibility = View.GONE
            curentTime.visibility = View.VISIBLE
